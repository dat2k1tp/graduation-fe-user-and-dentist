...
public class ProvincesController {
    ...
    @GetMapping()
    public ResponseEntity<Response<List<ProvincesDTO>> > getList() {
        Response<List<ProvincesDTO>> response = new Response<>();

        response.setData(this.provincesServices.findAll());
