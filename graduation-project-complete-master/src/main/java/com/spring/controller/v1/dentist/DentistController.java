...
public class DentistController {
	...
	public ResponseEntity<Response<List<DentistProfileDTO>>> getAllDentistOnRecycleBin() {
		Response<List<DentistProfileDTO>> response = new Response<>();
		response.setData(dentistService.getAllOnRecycleBin());
		return ResponseEntity.ok(response);
	}

	@GetMapping("/{id}")
	public ResponseEntity<Response<DentistProfileDTO>> getDentist(@PathVariable("id") Long id) throws NotFoundException {
		Response<DentistProfileDTO> response = new Response<>();
		response.setData(dentistService.getById(id));
		return ResponseEntity.ok(response);
	}

	@GetMapping("/accounts/{id}")
	public ResponseEntity<Response<DentistProfileDTO>> getByAccountsId(@PathVariable("id") Long id) throws NotFoundException {
		Response<DentistProfileDTO> response = new Response<>();
		response.setData(this.dentistService.getByAccountsId(id));
		return ResponseEntity.ok(response);
	}
