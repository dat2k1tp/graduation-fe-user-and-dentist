    ...
    return (
        <div>
            <BrowserRouter >
                    ...
                    <div className="container-fluid">
                        ...
                        <div className="collapse navbar-collapse " id="navbarSupportedContent">
                            ...
                            <ul className="navbar-nav me-auto mb-2 mb-lg-0 ">
                                ...
                                <li className="nav-item">
                                    {
                                        token !== null && auth.rolesId === 'ROLE_CUSTOMER' ? (
                                            <Link className="nav-link active" to="/book">Đặt lịch</Link>
                                        ) : ''
                                    }
                                </li>
                                <li className="nav-item">
                                    <Link className="nav-link active" to="/dentist">Nha sĩ</Link>
                                </li>
                                <li className="nav-item">
                                    <Link className="nav-link active" to="/news">Tin tức</Link>
                                </li>
                                <li className="nav-item">
                                    {
                                        token !== null && auth.rolesId === 'ROLE_CUSTOMER' ? (
                                            <Link className="nav-link active" to="/medicalRecords">Hồ sơ khám</Link>
                                        ) : ''
                                    }
                                </li>
                            </ul>
                                    ...
                                    <ul className="dropdown-menu" aria-labelledby="navbarDropdown">
                                        {
                                            token !== null && auth.rolesId === 'ROLE_CUSTOMER' ? (
                                                <div>
                                                    <li><Link className="dropdown-item" to="/account/userInformation">Thông tin cá nhân</Link></li>
                                                    <li><hr className="dropdown-divider" /></li>
                                                    <li><Link className="dropdown-item" to="" data-bs-toggle="modal" data-bs-target="#staticBackdrop">Đổi mật khẩu</Link></li>
                                                    <li><hr className="dropdown-divider" /></li>
                                                    <li><Link className="dropdown-item" to="/" onClick={btnLogout}>Đăng xuất</Link></li>
                ...
                {/* cuoi trang */}
                <footer >
                    <div style={{ background: '#f1f1f1', minHeight: '250px', paddingTop: '30px', textAlign: 'left', marginTop: '50px' }}>
                        <div className="container">
                            <div className="row col-sm-12  d-flex justify-content-center" >
                                ...
                                <div className="col-sm-3 offset-1">
                                    ...
                                    <i className="fas fa-envelope-open"></i> Email: <a className="text-dark" style={{ textDecoration: 'none' }} href="mailto:smiledentalfpt@gmail.com">smiledentalfpt@gmail.com</a>
                                </div>
                                <br />
                                <div className="col-sm-3 offset-1">
                                    <h5>LIÊN KẾT:</h5>
                                    <a target="_blank" rel="noopener noreferrer" href="https://www.facebook.com/fptSmileDental" style={{ textDecoration: "none", color: "black" }}><i className="fab fa-facebook"></i> Facebook</a><br />
                                    <a target="_blank" rel="noopener noreferrer" href="https://m.me/fptSmileDental" style={{ textDecoration: "none", color: "black" }}><i className="fab fa-facebook-messenger"></i> Messenger</a><br />
                                    <a target="_blank" rel="noopener noreferrer" href="https://twitter.com/fptSmileDental" style={{ textDecoration: "none", color: "black" }}><i className="fab fa-twitter"></i> Twitter</a><br />
                                </div>
                                <br />
                            </div>
                        </div>
                        <div style={{ background: '#353535', minHeight: '50px', textAlign: 'center', color: 'white', padding: '10px' }}>© Bản quyền thuộc về Smile Dental</div>
