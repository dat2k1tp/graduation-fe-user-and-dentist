                                ...
                                <div className="row g-0 d-flex justify-content-center">
                                    ...
                                    <div className="col-md-8">
                                        <div className="card-body">
                                            ...
                                            <p className="card-text"><span className="fw-bold">Ngày sinh:</span> {formatDate(val.birthday)}</p>
                                            ...
                                            <p className="card-text"><small className="text-muted">{val.updateAt!==null?'Cập nhật '+formatDate(val.updateAt):""}</small></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
