    ...
    http({
      ...
      .catch((error) => {
        ...
        data.errors.details !== null && typeof (data.errors.details) !== 'undefined'
          ? alert(data.errors.details) : console.log("ERROR NO MESSAGES");
      });
  };
          ...
          <div className="row text-start d-flex justify-content-center">
            <div className="col-sm-3 mx-5">
              ...
              <div>
                ...
                {errors.serviceId && (
                  <span className="text-danger">Chọn dịch vụ</span>
                )}
              </div>
              <br />
              ...
              <div>
                ...
                {errors.dentistProfile && (
                  <span className="text-danger">Chọn bác sĩ</span>
                )}
              </div>
              <br />
          ...
          <div>
            {
              customer.id ? (
                ...
                <Link to="/account/userInformation" className="btn btn-primary" onClick={btnAlert}>Đặt lịch</Link>
              )
            }
