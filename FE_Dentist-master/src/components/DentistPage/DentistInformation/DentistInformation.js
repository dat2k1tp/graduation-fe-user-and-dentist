...
export default function DentistInformation() {
    ...
    const formDataCccd = register("cccd", {
        ...
        pattern: { value: /((0)+([0-9]{11})\b)/g, message: "Nhập số căn cước bắt đầu bằng 0, 12 ký tự" },
        value: formData.cccd
    });
    ...
    const formDataExp = register("exp", { required: "Nhập kinh nghiệm(mô tả)",value: formData.exp });
                ...
                <form onSubmit={handleSubmit(onHandleSubmit)}>
                    <div className="row text-start d-flex justify-content-center">
                        ...
                        <div className="col-sm-3 mx-5">
                            ...
                            <div>
                                <label htmlFor="diachi" className="form-label">Địa chỉ nhà:</label>
                                <input type="text" className="form-control" placeholder="Nguyen Van An"
                    ...
                    <br />
                    <div>
                        <button type="submit" className="btn btn-primary mt-4 mb-5">Cập nhật</button>
                    </div>
                </form>
            </div>
        </div>
